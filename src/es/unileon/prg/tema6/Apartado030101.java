...
public class Apartado030101 extends Apartado {
	...
	public void ejercicio03() {
		...
		alumno.asignarNota(nota);
 		if(nota == Float.MIN_VALUE){
			System.out.println("mensaje: Los datos que se muestran a continuacion no son correctos");
		}
		else{
	...
	public void ejercicio08() {
		...
		numero1=Teclado.readInteger();
		numero2=Teclado.readInteger();
